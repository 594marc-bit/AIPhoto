          ...
          >
            ...
            <q-card-section class="q-pa-sm">
              ...
              <div class="text-caption text-grey">
                {{ imageStore.formatFileSize(image.size) }} · {{ image.width }}×{{ image.height }}
              </div>
            </q-card-section>
          </q-card>
        </div>
...
import { DEFAULT_UPLOAD_OPTIONS } from '@/utils/imageValidation';
...
const maxSize = computed(() => DEFAULT_UPLOAD_OPTIONS.maxSize);
